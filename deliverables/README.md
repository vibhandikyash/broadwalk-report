...
4. The completeness check reported no gap, so the version is marked complete and carries no draft marker. Generate PDF snapshotted the reviewed data, the layout check confirmed every page fits its box, and Chromium printed the PDF.
